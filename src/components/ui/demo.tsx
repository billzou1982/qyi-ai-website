...
export function SparklesPreviewDark() {
  return (
    <div className="h-full relative w-full bg-gradient-to-br from-slate-900 to-slate-950 flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* 渐变遮罩 - 右侧淡化，突出机器人区域 */}
      <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-transparent to-slate-950/20 pointer-events-none"></div>
    </div>
  );
}
