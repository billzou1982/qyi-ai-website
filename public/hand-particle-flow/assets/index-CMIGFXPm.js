...
`)+`
`+d);const L=U+_+a,P=U+d+l,I=bl(r,r.VERTEX_SHADER,L),O=bl(r,r.FRAGMENT_SHADER,P);r.attachShader(b,I),r.attachShader(b,O),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function N(A){if(i.debug.checkShaderErrors){const X=r.getProgramInfoLog(b)||"",G=r.getShaderInfoLog(I)||"",J=r.getShaderInfoLog(O)||"",Q=X.trim(),B=G.trim(),H=J.trim();let ee=!0,ue=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(ee=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,b,I,O);else{const fe=wl(r,I,"vertex"),Ee=wl(r,O,"fragment");ut("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
`+h.getProgramInfoLog(D));M=s.s=D,h.useProgram(M),w=h.getUniformLocation(M,"sampler0"),s.l={O:h.getAttribLocation(M,"aVertex"),N:h.getAttribLocation(M,"aTex"),xa:w},s.v=h.createBuffer(),h.bindBuffer(h.ARRAY_BUFFER,s.v),h.enableVertexAttribArray(s.l.O),h.vertexAttribPointer(s.l.O,2,h.FLOAT,!1,0,0),h.bufferData(h.ARRAY_BUFFER,new Float32Array([-1,-1,-1,1,1,1,1,-1]),h.STATIC_DRAW),h.bindBuffer(h.ARRAY_BUFFER,null),s.u=h.createBuffer(),h.bindBuffer(h.ARRAY_BUFFER,s.u),h.enableVertexAttribArray(s.l.N),h.vertexAttribPointer(s.l.N,2,h.FLOAT,!1,0,0),h.bufferData(h.ARRAY_BUFFER,new Float32Array([0,1,0,0,1,0,1,1]),h.STATIC_DRAW),h.bindBuffer(h.ARRAY_BUFFER,null),h.uniform1i(w,0)}M=s.l,h.useProgram(s.s),h.canvas.width=c.width,h.canvas.height=c.height,h.viewport(0,0,c.width,c.height),h.activeTexture(h.TEXTURE0),s.i.bindTexture2d(c.glName),h.enableVertexAttribArray(M.O),h.bindBuffer(h.ARRAY_BUFFER,s.v),h.vertexAttribPointer(M.O,2,h.FLOAT,!1,0,0),h.enableVertexAttribArray(M.N),h.bindBuffer(h.ARRAY_BUFFER,s.u),h.vertexAttribPointer(M.N,2,h.FLOAT,!1,0,0),h.bindFramebuffer(h.DRAW_FRAMEBUFFER?h.DRAW_FRAMEBUFFER:h.FRAMEBUFFER,null),h.clearColor(0,0,0,0),h.clear(h.COLOR_BUFFER_BIT),h.colorMask(!0,!0,!0,!0),h.drawArrays(h.TRIANGLE_FAN,0,4),h.disableVertexAttribArray(M.O),h.disableVertexAttribArray(M.N),h.bindBuffer(h.ARRAY_BUFFER,null),s.i.bindTexture2d(0)}function Fc(s){this.h=s}var Oc=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,2,1,0,10,9,1,7,0,65,0,253,15,26,11]);function Bc(s,c){return c+s}function Na(s,c){window[s]=c}function zc(s){var c=document.createElement("script");return c.setAttribute("src",s),c.setAttribute("crossorigin","anonymous"),new Promise(function(h){c.addEventListener("load",function(){h()},!1),c.addEventListener("error",function(){h()},!1),document.body.appendChild(c)})}function Vc(){return A(function(s){switch(s.h){case 1:return s.s=2,P(s,WebAssembly.instantiate(Oc),4);case 4:s.h=3,s.s=0;break;case 2:return s.s=0,s.l=null,s.return(!1);case 3:return s.return(!0)}})}function Ps(s){if(this.h=s,this.listeners={},this.l={},this.L={},this.s={},this.v={},this.M=this.u=this.ga=!0,this.I=Promise.resolve(),this.fa="",this.D={},this.locateFile=s&&s.locateFile||Bc,typeof window=="object")var c=window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/";else if(typeof location<"u")c=location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/";else throw Error("solutions can only be loaded on a web page or in a web worker");if(this.ha=c,s.options){c=l(Object.keys(s.options));for(var h=c.next();!h.done;h=c.next()){h=h.value;var M=s.options[h].default;M!==void 0&&(this.l[h]=typeof M=="function"?M():M)}}}i=Ps.prototype,i.close=function(){return this.j&&this.j.delete(),Promise.resolve()};function Gc(s){var c,h,M,w,D,C,V,$,ce,ve,We;return A(function(Fe){switch(Fe.h){case 1:return s.ga?(c=s.h.files===void 0?[]:typeof s.h.files=="function"?s.h.files(s.l):s.h.files,P(Fe,Vc(),2)):Fe.return();case 2:if(h=Fe.i,typeof window=="object")return Na("createMediapipeSolutionsWasm",{locateFile:s.locateFile}),Na("createMediapipeSolutionsPackedAssets",{locateFile:s.locateFile}),C=c.filter(function(Te){return Te.data!==void 0}),V=c.filter(function(Te){return Te.data===void 0}),$=Promise.all(C.map(function(Te){var Xe=Lr(s,Te.url);if(Te.path!==void 0){var et=Te.path;Xe=Xe.then(function(Tt){return s.overrideFile(et,Tt),Promise.resolve(Tt)})}return Xe})),ce=Promise.all(V.map(function(Te){return Te.simd===void 0||Te.simd&&h||!Te.simd&&!h?zc(s.locateFile(Te.url,s.ha)):Promise.resolve()})).then(function(){var Te,Xe,et;return A(function(Tt){if(Tt.h==1)return Te=window.createMediapipeSolutionsWasm,Xe=window.createMediapipeSolutionsPackedAssets,et=s,P(Tt,Te(Xe),2);et.i=Tt.i,Tt.h=0})}),ve=(function(){return A(function(Te){return s.h.graph&&s.h.graph.url?Te=P(Te,Lr(s,s.h.graph.url),0):(Te.h=0,Te=void 0),Te})})(),P(Fe,Promise.all([ce,$,ve]),7);if(typeof importScripts!="function")throw Error("solutions can only be loaded on a web page or in a web worker");return M=c.filter(function(Te){return Te.simd===void 0||Te.simd&&h||!Te.simd&&!h}).map(function(Te){return s.locateFile(Te.url,s.ha)}),importScripts.apply(null,u(M)),w=s,P(Fe,createMediapipeSolutionsWasm(Module),6);case 6:w.i=Fe.i,s.m=new OffscreenCanvas(1,1),s.i.canvas=s.m,D=s.i.GL.createContext(s.m,{antialias:!1,alpha:!1,ua:typeof WebGL2RenderingContext<"u"?2:1}),s.i.GL.makeContextCurrent(D),Fe.h=4;break;case 7:if(s.m=document.createElement("canvas"),We=s.m.getContext("webgl2",{}),!We&&(We=s.m.getContext("webgl",{}),!We))return alert("Failed to create WebGL canvas context when passing video frame."),Fe.return();s.K=We,s.i.canvas=s.m,s.i.createContext(s.m,!0,!0,{});case 4:s.j=new s.i.SolutionWasm,s.ga=!1,Fe.h=0}})}function Hc(s){var c,h,M,w,D,C,V,$;return A(function(ce){if(ce.h==1){if(s.h.graph&&s.h.graph.url&&s.fa===s.h.graph.url)return ce.return();if(s.u=!0,!s.h.graph||!s.h.graph.url){ce.h=2;return}return s.fa=s.h.graph.url,P(ce,Lr(s,s.h.graph.url),3)}for(ce.h!=2&&(c=ce.i,s.j.loadGraph(c)),h=l(Object.keys(s.D)),M=h.next();!M.done;M=h.next())w=M.value,s.j.overrideFile(w,s.D[w]);if(s.D={},s.h.listeners)for(D=l(s.h.listeners),C=D.next();!C.done;C=D.next())V=C.value,qc(s,V);$=s.l,s.l={},s.setOptions($),ce.h=0})}i.reset=function(){var s=this;return A(function(c){s.j&&(s.j.reset(),s.s={},s.v={}),c.h=0})},i.setOptions=function(s,c){var h=this;if(c=c||this.h.options){for(var M=[],w=[],D={},C=l(Object.keys(s)),V=C.next();!V.done;D={X:D.X,Y:D.Y},V=C.next())if(V=V.value,!(V in this.l&&this.l[V]===s[V])){this.l[V]=s[V];var $=c[V];$!==void 0&&($.onChange&&(D.X=$.onChange,D.Y=s[V],M.push((function(ce){return function(){var ve;return A(function(We){if(We.h==1)return P(We,ce.X(ce.Y),2);ve=We.i,ve===!0&&(h.u=!0),We.h=0})}})(D))),$.graphOptionXref&&(V=Object.assign({},{calculatorName:"",calculatorIndex:0},$.graphOptionXref,{valueNumber:$.type===1?s[V]:0,valueBoolean:$.type===0?s[V]:!1,valueString:$.type===2?s[V]:""}),w.push(V)))}(M.length!==0||w.length!==0)&&(this.u=!0,this.H=(this.H===void 0?[]:this.H).concat(w),this.F=(this.F===void 0?[]:this.F).concat(M))}};function kc(s){var c,h,M,w,D,C,V;return A(function($){switch($.h){case 1:if(!s.u)return $.return();if(!s.F){$.h=2;break}c=l(s.F),h=c.next();case 3:if(h.done){$.h=5;break}return M=h.value,P($,M(),4);case 4:h=c.next(),$.h=3;break;case 5:s.F=void 0;case 2:if(s.H){for(w=new s.i.GraphOptionChangeRequestList,D=l(s.H),C=D.next();!C.done;C=D.next())V=C.value,w.push_back(V);s.j.changeOptions(w),w.delete(),s.H=void 0}s.u=!1,$.h=0}})}i.initialize=function(){var s=this;return A(function(c){return c.h==1?P(c,Gc(s),2):c.h!=3?P(c,Hc(s),3):P(c,kc(s),0)})};function Lr(s,c){var h,M;return A(function(w){return c in s.L?w.return(s.L[c]):(h=s.locateFile(c,""),M=fetch(h).then(function(D){return D.arrayBuffer()}),s.L[c]=M,w.return(M))})}i.overrideFile=function(s,c){this.j?this.j.overrideFile(s,c):this.D[s]=c},i.clearOverriddenFiles=function(){this.D={},this.j&&this.j.clearOverriddenFiles()},i.send=function(s,c){var h=this,M,w,D,C,V,$,ce,ve,We;return A(function(Fe){switch(Fe.h){case 1:return h.h.inputs?(M=1e3*(c??performance.now()),P(Fe,h.I,2)):Fe.return();case 2:return P(Fe,h.initialize(),3);case 3:for(w=new h.i.PacketDataList,D=l(Object.keys(s)),C=D.next();!C.done;C=D.next())if(V=C.value,$=h.h.inputs[V]){e:{var Te=s[V];switch($.type){case"video":var Xe=h.s[$.stream];if(Xe||(Xe=new Cs(h.i,h.K),h.s[$.stream]=Xe),Xe.m===0&&(Xe.m=Xe.i.createTexture()),typeof HTMLVideoElement<"u"&&Te instanceof HTMLVideoElement)var et=Te.videoWidth,Tt=Te.videoHeight;else typeof HTMLImageElement<"u"&&Te instanceof HTMLImageElement?(et=Te.naturalWidth,Tt=Te.naturalHeight):(et=Te.width,Tt=Te.height);Tt={glName:Xe.m,width:et,height:Tt},et=Xe.h,et.canvas.width=Tt.width,et.canvas.height=Tt.height,et.activeTexture(et.TEXTURE0),Xe.i.bindTexture2d(Xe.m),et.texImage2D(et.TEXTURE_2D,0,et.RGBA,et.RGBA,et.UNSIGNED_BYTE,Te),Xe.i.bindTexture2d(0),Xe=Tt;break e;case"detections":for(Xe=h.s[$.stream],Xe||(Xe=new Fc(h.i),h.s[$.stream]=Xe),Xe.data||(Xe.data=new Xe.h.DetectionListData),Xe.data.reset(Te.length),Tt=0;Tt<Te.length;++Tt){et=Te[Tt];var Mt=Xe.data,Vt=Mt.setBoundingBox,un=Tt,Jt=et.la,ct=new Dr;if(Y(ct,1,Jt.ra),Y(ct,2,Jt.sa),Y(ct,3,Jt.height),Y(ct,4,Jt.width),Y(ct,5,Jt.rotation),cn(ct,6,Jt.pa),Jt=ct.l(),Vt.call(Mt,un,Jt),et.ea)for(Mt=0;Mt<et.ea.length;++Mt){ct=et.ea[Mt],Vt=Xe.data,un=Vt.addNormalizedLandmark,Jt=Tt,ct=Object.assign({},ct,{visibility:ct.visibility?ct.visibility:0});var Gt=new wi;Y(Gt,1,ct.x),Y(Gt,2,ct.y),Y(Gt,3,ct.z),ct.visibility&&Y(Gt,4,ct.visibility),ct=Gt.l(),un.call(Vt,Jt,ct)}if(et.ba)for(Mt=0;Mt<et.ba.length;++Mt)Vt=Xe.data,un=Vt.addClassification,Jt=Tt,ct=et.ba[Mt],Gt=new Ai,Y(Gt,2,ct.score),ct.index&&cn(Gt,1,ct.index),ct.label&&cn(Gt,3,ct.label),ct.displayName&&cn(Gt,4,ct.displayName),ct=Gt.l(),un.call(Vt,Jt,ct)}Xe=Xe.data;break e;default:Xe={}}}switch(ce=Xe,ve=$.stream,$.type){case"video":w.pushTexture2d(Object.assign({},ce,{stream:ve,timestamp:M}));break;case"detections":We=ce,We.stream=ve,We.timestamp=M,w.pushDetectionList(We);break;default:throw Error("Unknown input config type: '"+$.type+"'")}}return h.j.send(w),P(Fe,h.I,4);case 4:w.delete(),Fe.h=0}})};function Wc(s,c,h){var M,w,D,C,V,$,ce,ve,We,Fe,Te,Xe,et,Tt;return A(function(Mt){switch(Mt.h){case 1:if(!h)return Mt.return(c);for(M={},w=0,D=l(Object.keys(h)),C=D.next();!C.done;C=D.next())V=C.value,$=h[V],typeof $!="string"&&$.type==="texture"&&c[$.stream]!==void 0&&++w;1<w&&(s.M=!1),ce=l(Object.keys(h)),C=ce.next();case 2:if(C.done){Mt.h=4;break}if(ve=C.value,We=h[ve],typeof We=="string")return et=M,Tt=ve,P(Mt,Xc(s,ve,c[We]),14);if(Fe=c[We.stream],We.type==="detection_list"){if(Fe){for(var Vt=Fe.getRectList(),un=Fe.getLandmarksList(),Jt=Fe.getClassificationsList(),ct=[],Gt=0;Gt<Vt.size();++Gt){var Kn=Ic(Vt.get(Gt)),jc=Me(Kn,1),Yc=Me(Kn,2),Kc=Me(Kn,3),Zc=Me(Kn,4),$c=Me(Kn,5,0),Ur=void 0;Ur=Ur===void 0?0:Ur,Kn={la:{ra:jc,sa:Yc,height:Kc,width:Zc,rotation:$c,pa:ge(nn(Kn,6),Ur)},ea:Z(Ra(un.get(Gt)),wi,1).map(La),ba:Da(ba(Jt.get(Gt)))},ct.push(Kn)}Vt=ct}else Vt=[];M[ve]=Vt,Mt.h=7;break}if(We.type==="proto_list"){if(Fe){for(Vt=Array(Fe.size()),un=0;un<Fe.size();un++)Vt[un]=Fe.get(un);Fe.delete()}else Vt=[];M[ve]=Vt,Mt.h=7;break}if(Fe===void 0){Mt.h=3;break}if(We.type==="float_list"){M[ve]=Fe,Mt.h=7;break}if(We.type==="proto"){M[ve]=Fe,Mt.h=7;break}if(We.type!=="texture")throw Error("Unknown output config type: '"+We.type+"'");return Te=s.v[ve],Te||(Te=new Cs(s.i,s.K),s.v[ve]=Te),P(Mt,Ia(Te,Fe,s.M),13);case 13:Xe=Mt.i,M[ve]=Xe;case 7:We.transform&&M[ve]&&(M[ve]=We.transform(M[ve])),Mt.h=3;break;case 14:et[Tt]=Mt.i;case 3:C=ce.next(),Mt.h=2;break;case 4:return Mt.return(M)}})}function Xc(s,c,h){var M;return A(function(w){return typeof h=="number"||h instanceof Uint8Array||h instanceof s.i.Uint8BlobList?w.return(h):h instanceof s.i.Texture2dDataOut?(M=s.v[c],M||(M=new Cs(s.i,s.K),s.v[c]=M),w.return(Ia(M,h,s.M))):w.return(void 0)})}function qc(s,c){for(var h=c.name||"$",M=[].concat(u(c.wants)),w=new s.i.StringList,D=l(c.wants),C=D.next();!C.done;C=D.next())w.push_back(C.value);D=s.i.PacketListener.implement({onResults:function(V){for(var $={},ce=0;ce<c.wants.length;++ce)$[M[ce]]=V.get(ce);var ve=s.listeners[h];ve&&(s.I=Wc(s,$,c.outs).then(function(We){We=ve(We);for(var Fe=0;Fe<c.wants.length;++Fe){var Te=$[M[Fe]];typeof Te=="object"&&Te.hasOwnProperty&&Te.hasOwnProperty("delete")&&Te.delete()}We&&(s.I=We)}))}}),s.j.attachMultiListener(w,D),w.delete()}i.onResults=function(s,c){this.listeners[c||"$"]=s},Q("Solution",Ps),Q("OptionType",{BOOL:0,NUMBER:1,ta:2,0:"BOOL",1:"NUMBER",2:"STRING"});function Fa(s){return s===void 0&&(s=0),s===1?"hand_landmark_full.tflite":"hand_landmark_lite.tflite"}function Oa(s){var c=this;s=s||{},this.h=new Ps({locateFile:s.locateFile,files:function(h){return[{url:"hands_solution_packed_assets_loader.js"},{simd:!1,url:"hands_solution_wasm_bin.js"},{simd:!0,url:"hands_solution_simd_wasm_bin.js"},{data:!0,url:Fa(h.modelComplexity)}]},graph:{url:"hands.binarypb"},inputs:{image:{type:"video",stream:"input_frames_gpu"}},listeners:[{wants:["multi_hand_landmarks","multi_hand_world_landmarks","image_transformed","multi_handedness"],outs:{image:"image_transformed",multiHandLandmarks:{type:"proto_list",stream:"multi_hand_landmarks",transform:Ua},multiHandWorldLandmarks:{type:"proto_list",stream:"multi_hand_world_landmarks",transform:Ua},multiHandedness:{type:"proto_list",stream:"multi_handedness",transform:function(h){return h.map(function(M){return Da(ba(M))[0]})}}}}],options:{useCpuInference:{type:0,graphOptionXref:{calculatorType:"InferenceCalculator",fieldName:"use_cpu_inference"},default:typeof window!="object"||window.navigator===void 0?!1:"iPad Simulator;iPhone Simulator;iPod Simulator;iPad;iPhone;iPod".split(";").includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document},selfieMode:{type:0,graphOptionXref:{calculatorType:"GlScalerCalculator",calculatorIndex:1,fieldName:"flip_horizontal"}},maxNumHands:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculator",fieldName:"int_value"}},modelComplexity:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorModelComplexity",fieldName:"int_value"},onChange:function(h){var M,w,D;return A(function(C){return C.h==1?(M=Fa(h),w="third_party/mediapipe/modules/hand_landmark/"+M,P(C,Lr(c.h,M),2)):(D=C.i,c.h.overrideFile(w,D),C.return(!0))})}},minDetectionConfidence:{type:1,graphOptionXref:{calculatorType:"TensorsToDetectionsCalculator",calculatorName:"handlandmarktrackinggpu__palmdetectiongpu__TensorsToDetectionsCalculator",fieldName:"min_score_thresh"}},minTrackingConfidence:{type:1,graphOptionXref:{calculatorType:"ThresholdingCalculator",calculatorName:"handlandmarktrackinggpu__handlandmarkgpu__ThresholdingCalculator",fieldName:"threshold"}}}})}i=Oa.prototype,i.close=function(){return this.h.close(),Promise.resolve()},i.onResults=function(s){this.h.onResults(s)},i.initialize=function(){var s=this;return A(function(c){return P(c,s.h.initialize(),0)})},i.reset=function(){this.h.reset()},i.send=function(s){var c=this;return A(function(h){return P(h,c.h.send(s),0)})},i.setOptions=function(s){this.h.setOptions(s)},Q("Hands",Oa),Q("HAND_CONNECTIONS",[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[9,10],[10,11],[11,12],[9,13],[13,14],[14,15],[15,16],[13,17],[0,17],[17,18],[18,19],[19,20]]),Q("VERSION","0.4.1675469240")}).call(co)),co}var mg=pg(),uo={},Ol;function gg(){return Ol||(Ol=1,(function(){function i(v){var A=0;return function(){return A<v.length?{done:!1,value:v[A++]}:{done:!0}}}var e=typeof Object.defineProperties=="function"?Object.defineProperty:function(v,A,X){return v==Array.prototype||v==Object.prototype||(v[A]=X.value),v};function t(v){v=[typeof globalThis=="object"&&globalThis,v,typeof window=="object"&&window,typeof self=="object"&&self,typeof vs=="object"&&vs];for(var A=0;A<v.length;++A){var X=v[A];if(X&&X.Math==Math)return X}throw Error("Cannot find global object")}var n=t(this);function r(v,A){if(A)e:{var X=n;v=v.split(".");for(var G=0;G<v.length-1;G++){var J=v[G];if(!(J in X))break e;X=X[J]}v=v[v.length-1],G=X[v],A=A(G),A!=G&&A!=null&&e(X,v,{configurable:!0,writable:!0,value:A})}}r("Symbol",function(v){function A(Q){if(this instanceof A)throw new TypeError("Symbol is not a constructor");return new X(G+(Q||"")+"_"+J++,Q)}function X(Q,B){this.g=Q,e(this,"description",{configurable:!0,writable:!0,value:B})}if(v)return v;X.prototype.toString=function(){return this.g};var G="jscomp_symbol_"+(1e9*Math.random()>>>0)+"_",J=0;return A}),r("Symbol.iterator",function(v){if(v)return v;v=Symbol("Symbol.iterator");for(var A="Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "),X=0;X<A.length;X++){var G=n[A[X]];typeof G=="function"&&typeof G.prototype[v]!="function"&&e(G.prototype,v,{configurable:!0,writable:!0,value:function(){return o(i(this))}})}return v});function o(v){return v={next:v},v[Symbol.iterator]=function(){return this},v}function a(v){var A=typeof Symbol<"u"&&Symbol.iterator&&v[Symbol.iterator];return A?A.call(v):{next:i(v)}}function l(){this.i=!1,this.g=null,this.o=void 0,this.j=1,this.m=0,this.h=null}function u(v){if(v.i)throw new TypeError("Generator is already running");v.i=!0}l.prototype.l=function(v){this.o=v};function f(v,A){v.h={F:A,G:!0},v.j=v.m}l.prototype.return=function(v){this.h={return:v},this.j=this.m};function p(v){this.g=new l,this.h=v}function m(v,A){u(v.g);var X=v.g.g;return X?g(v,"return"in X?X.return:function(G){return{value:G,done:!0}},A,v.g.return):(v.g.return(A),S(v))}function g(v,A,X,G){try{var J=A.call(v.g.g,X);if(!(J instanceof Object))throw new TypeError("Iterator result "+J+" is not an object");if(!J.done)return v.g.i=!1,J;var Q=J.value}catch(B){return v.g.g=null,f(v.g,B),S(v)}return v.g.g=null,G.call(v.g,Q),S(v)}function S(v){for(;v.g.j;)try{var A=v.h(v.g);if(A)return v.g.i=!1,{value:A.value,done:!1}}catch(X){v.g.o=void 0,f(v.g,X)}if(v.g.i=!1,v.g.h){if(A=v.g.h,v.g.h=null,A.G)throw A.F;return{value:A.return,done:!0}}return{value:void 0,done:!0}}function E(v){this.next=function(A){return u(v.g),v.g.g?A=g(v,v.g.g.next,A,v.g.l):(v.g.l(A),A=S(v)),A},this.throw=function(A){return u(v.g),v.g.g?A=g(v,v.g.g.throw,A,v.g.l):(f(v.g,A),A=S(v)),A},this.return=function(A){return m(v,A)},this[Symbol.iterator]=function(){return this}}function b(v){function A(G){return v.next(G)}function X(G){return v.throw(G)}return new Promise(function(G,J){function Q(B){B.done?G(B.value):Promise.resolve(B.value).then(A,X).then(Q,J)}Q(v.next())})}r("Promise",function(v){function A(B){this.h=0,this.i=void 0,this.g=[],this.o=!1;var H=this.j();try{B(H.resolve,H.reject)}catch(ee){H.reject(ee)}}function X(){this.g=null}function G(B){return B instanceof A?B:new A(function(H){H(B)})}if(v)return v;X.prototype.h=function(B){if(this.g==null){this.g=[];var H=this;this.i(function(){H.l()})}this.g.push(B)};var J=n.setTimeout;X.prototype.i=function(B){J(B,0)},X.prototype.l=function(){for(;this.g&&this.g.length;){var B=this.g;this.g=[];for(var H=0;H<B.length;++H){var ee=B[H];B[H]=null;try{ee()}catch(ue){this.j(ue)}}}this.g=null},X.prototype.j=function(B){this.i(function(){throw B})},A.prototype.j=function(){function B(ue){return function(fe){ee||(ee=!0,ue.call(H,fe))}}var H=this,ee=!1;return{resolve:B(this.A),reject:B(this.l)}},A.prototype.A=function(B){if(B===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(B instanceof A)this.C(B);else{e:switch(typeof B){case"object":var H=B!=null;break e;case"function":H=!0;break e;default:H=!1}H?this.v(B):this.m(B)}},A.prototype.v=function(B){var H=void 0;try{H=B.then}catch(ee){this.l(ee);return}typeof H=="function"?this.D(H,B):this.m(B)},A.prototype.l=function(B){this.u(2,B)},A.prototype.m=function(B){this.u(1,B)},A.prototype.u=function(B,H){if(this.h!=0)throw Error("Cannot settle("+B+", "+H+"): Promise already settled in state"+this.h);this.h=B,this.i=H,this.h===2&&this.B(),this.H()},A.prototype.B=function(){var B=this;J(function(){if(B.I()){var H=n.console;typeof H<"u"&&H.error(B.i)}},1)},A.prototype.I=function(){if(this.o)return!1;var B=n.CustomEvent,H=n.Event,ee=n.dispatchEvent;return typeof ee>"u"?!0:(typeof B=="function"?B=new B("unhandledrejection",{cancelable:!0}):typeof H=="function"?B=new H("unhandledrejection",{cancelable:!0}):(B=n.document.createEvent("CustomEvent"),B.initCustomEvent("unhandledrejection",!1,!0,B)),B.promise=this,B.reason=this.i,ee(B))},A.prototype.H=function(){if(this.g!=null){for(var B=0;B<this.g.length;++B)Q.h(this.g[B]);this.g=null}};var Q=new X;return A.prototype.C=function(B){var H=this.j();B.s(H.resolve,H.reject)},A.prototype.D=function(B,H){var ee=this.j();try{B.call(H,ee.resolve,ee.reject)}catch(ue){ee.reject(ue)}},A.prototype.then=function(B,H){function ee(Ve,Ge){return typeof Ve=="function"?function(dt){try{ue(Ve(dt))}catch(at){fe(at)}}:Ge}var ue,fe,Ee=new A(function(Ve,Ge){ue=Ve,fe=Ge});return this.s(ee(B,ue),ee(H,fe)),Ee},A.prototype.catch=function(B){return this.then(void 0,B)},A.prototype.s=function(B,H){function ee(){switch(ue.h){case 1:B(ue.i);break;case 2:H(ue.i);break;default:throw Error("Unexpected state: "+ue.h)}}var ue=this;this.g==null?Q.h(ee):this.g.push(ee),this.o=!0},A.resolve=G,A.reject=function(B){return new A(function(H,ee){ee(B)})},A.race=function(B){return new A(function(H,ee){for(var ue=a(B),fe=ue.next();!fe.done;fe=ue.next())G(fe.value).s(H,ee)})},A.all=function(B){var H=a(B),ee=H.next();return ee.done?G([]):new A(function(ue,fe){function Ee(dt){return function(at){Ve[dt]=at,Ge--,Ge==0&&ue(Ve)}}var Ve=[],Ge=0;do Ve.push(void 0),Ge++,G(ee.value).s(Ee(Ve.length-1),fe),ee=H.next();while(!ee.done)})},A});var _=typeof Object.assign=="function"?Object.assign:function(v,A){for(var X=1;X<arguments.length;X++){var G=arguments[X];if(G)for(var J in G)Object.prototype.hasOwnProperty.call(G,J)&&(v[J]=G[J])}return v};r("Object.assign",function(v){return v||_});var d=this||self,U={facingMode:"user",width:640,height:480};function L(v,A){this.video=v,this.i=0,this.h=Object.assign(Object.assign({},U),A)}L.prototype.stop=function(){var v=this,A,X,G,J;return b(new E(new p(function(Q){if(v.g){for(A=v.g.getTracks(),X=a(A),G=X.next();!G.done;G=X.next())J=G.value,J.stop();v.g=void 0}Q.j=0})))},L.prototype.start=function(){var v=this,A;return b(new E(new p(function(X){return navigator.mediaDevices&&navigator.mediaDevices.getUserMedia||alert("No navigator.mediaDevices.getUserMedia exists."),A=v.h,X.return(navigator.mediaDevices.getUserMedia({video:{facingMode:A.facingMode,width:A.width,height:A.height}}).then(function(G){I(v,G)}).catch(function(G){var J="Failed to acquire camera feed: "+G;throw console.error(J),alert(J),G}))})))};function P(v){window.requestAnimationFrame(function(){O(v)})}function I(v,A){v.g=A,v.video.srcObject=A,v.video.onloadedmetadata=function(){v.video.play(),P(v)}}function O(v){var A=null;v.video.paused||v.video.currentTime===v.i||(v.i=v.video.currentTime,A=v.h.onFrame()),A?A.then(function(){P(v)}):P(v)}var N=["Camera"],j=d;N[0]in j||typeof j.execScript>"u"||j.execScript("var "+N[0]);for(var T;N.length&&(T=N.shift());)N.length||L===void 0?j[T]&&j[T]!==Object.prototype[T]?j=j[T]:j=j[T]={}:j[T]=L}).call(uo)),uo}var _g=gg();class vg{constructor(e=5e3,t=10){this.particleCount=e,this.worldRange=t,this.params={homeForce:.02,repulsionForce:.5,repulsionRadius:3,friction:.95,maxVelocity:.5,colorSpeed:.01},this.handPosition=new K(0,0,0),this.handActive=!1,this.initParticles(),this.createThreeJSObjects()}initParticles(){const e=this.particleCount;this.positions=new Float32Array(e*3),this.homePositions=new Float32Array(e*3),this.velocities=new Float32Array(e*3),this.colors=new Float32Array(e*3);for(let t=0;t<e;t++){const n=t*3,r=(Math.random()-.5)*this.worldRange*2,o=(Math.random()-.5)*this.worldRange*2,a=(Math.random()-.5)*this.worldRange*1.5;this.positions[n]=r,this.positions[n+1]=o,this.positions[n+2]=a,this.homePositions[n]=r,this.homePositions[n+1]=o,this.homePositions[n+2]=a,this.velocities[n]=0,this.velocities[n+1]=0,this.velocities[n+2]=0,this.colors[n]=0,this.colors[n+1]=.8,this.colors[n+2]=1}}createThreeJSObjects(){this.geometry=new ln,this.geometry.setAttribute("position",new an(this.positions,3)),this.geometry.setAttribute("color",new an(this.colors,3)),this.material=new hc({size:.15,vertexColors:!0,blending:hs,transparent:!0,opacity:.8,depthWrite:!1,sizeAttenuation:!0}),this.points=new uf(this.geometry,this.material)}updateHandPosition(e,t=!0){this.handPosition.copy(e),this.handActive=t}update(){const e=this.particleCount,t=this.geometry.attributes.position,n=this.geometry.attributes.color,r=new K,o=new K,a=new K;for(let l=0;l<e;l++){const u=l*3;if(r.set(this.positions[u],this.positions[u+1],this.positions[u+2]),o.set(this.homePositions[u]-this.positions[u],this.homePositions[u+1]-this.positions[u+1],this.homePositions[u+2]-this.positions[u+2]),this.velocities[u]+=o.x*this.params.homeForce,this.velocities[u+1]+=o.y*this.params.homeForce,this.velocities[u+2]+=o.z*this.params.homeForce,this.handActive){a.copy(this.handPosition).sub(r);const m=a.length();if(m<this.params.repulsionRadius){const g=this.params.repulsionForce*(1-m/this.params.repulsionRadius)**2;a.normalize().multiplyScalar(-g),this.velocities[u]+=a.x,this.velocities[u+1]+=a.y,this.velocities[u+2]+=a.z}}this.velocities[u]*=this.params.friction,this.velocities[u+1]*=this.params.friction,this.velocities[u+2]*=this.params.friction;const f=Math.sqrt(this.velocities[u]**2+this.velocities[u+1]**2+this.velocities[u+2]**2);if(f>this.params.maxVelocity){const m=this.params.maxVelocity/f;this.velocities[u]*=m,this.velocities[u+1]*=m,this.velocities[u+2]*=m}this.positions[u]+=this.velocities[u],this.positions[u+1]+=this.velocities[u+1],this.positions[u+2]+=this.velocities[u+2];const p=f/this.params.maxVelocity;this.colors[u]=p*.8,this.colors[u+1]=.8+p*.2,this.colors[u+2]=1}t.needsUpdate=!0,n.needsUpdate=!0}getObject(){return this.points}dispose(){this.geometry.dispose(),this.material.dispose()}}function xg(i,e,t=0,n=10){const r=(1-i)*n*2-n,o=-(e*n*2-n),a=t*n*.5;return{x:r,y:o,z:a}}function fo(i,e,t=.2){return i+(e-i)*t}function Sg(i,e,t=.2){return{x:fo(i.x,e.x,t),y:fo(i.y,e.y,t),z:fo(i.z,e.z,t)}}let ri,Mr,ki,xs,ss,Sc={x:0,y:0,z:0},pr={x:0,y:0,z:0},Ss=!1,si=[];const Mg=20;let Hi=null;function yg(){ri=new rf,ri.background=new ft(0);const i=window.innerWidth/window.innerHeight;Mr=new dn(75,i,.1,1e3),Mr.position.z=15,ki=new dg({antialias:!0,alpha:!0,preserveDrawingBuffer:!1}),ki.setSize(window.innerWidth,window.innerHeight),ki.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.getElementById("canvas-container").appendChild(ki.domElement),Eg(),xs=new vg(5e3,10),ri.add(xs.getObject());const t=new gf(16777215,.5);ri.add(t),window.addEventListener("resize",Rg),console.log("✅ Three.js initialized")}function Eg(){const i=new wr(100,100),e=new xa({color:0,transparent:!0,opacity:.05,depthWrite:!1});ss=new Dn(i,e),ss.position.z=14,ss.renderOrder=1e3,ri.add(ss)}async function Tg(){const i=document.getElementById("webcam"),e=new mg.Hands({locateFile:n=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${n}`});e.setOptions({maxNumHands:1,modelComplexity:1,minDetectionConfidence:.7,minTrackingConfidence:.7}),e.onResults(bg),await new _g.Camera(i,{onFrame:async()=>{await e.send({image:i})},width:1280,height:720}).start(),console.log("✅ MediaPipe initialized")}function bg(i){if(i.multiHandLandmarks&&i.multiHandLandmarks.length>0){const t=i.multiHandLandmarks[0][8],n=xg(t.x,t.y,t.z,10);Sc=n,Ss=!0,Ag(n)}else Ss=!1}function Ag(i){si.push({...i}),si.length>Mg&&si.shift(),si.length>=2&&wg()}function wg(){Hi&&(ri.remove(Hi),Hi.geometry.dispose(),Hi.material.dispose());const i=si.map(r=>new K(r.x,r.y,r.z)),e=new ln().setFromPoints(i),t=new Float32Array(si.length*3);for(let r=0;r<si.length;r++){const o=r/si.length;t[r*3]=0+o*1,t[r*3+1]=.8+o*.2,t[r*3+2]=1}e.setAttribute("color",new an(t,3));const n=new fc({vertexColors:!0,linewidth:2,transparent:!0,opacity:.8,blending:hs});Hi=new cf(e,n),ri.add(Hi)}function Rg(){Mr.aspect=window.innerWidth/window.innerHeight,Mr.updateProjectionMatrix(),ki.setSize(window.innerWidth,window.innerHeight)}function Mc(){requestAnimationFrame(Mc),Ss&&(pr=Sg(pr,Sc,.2));const i=new K(pr.x,pr.y,pr.z);xs.updateHandPosition(i,Ss),xs.update(),ki.render(ri,Mr)}function Cg(){yg(),Mc(),console.log("✅ Three.js initialized, waiting for user interaction")}async function Pg(){const i=document.getElementById("start-overlay"),e=document.getElementById("loading");try{i.classList.add("hidden"),e.style.display="flex",await Tg(),e.classList.add("hidden"),console.log("✅ Application ready")}catch(t){console.error("❌ Camera initialization error:",t),e.innerHTML=`
    ...
    `,e.style.display="flex"}}Cg();const Dg=document.getElementById("start-btn");Dg.addEventListener("click",Pg);
