...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function mp(i,e,t){const n=new Float32Array(Si),r=new K(0,1,0);return new Ln({name:"SphericalGaussianBlur",defines:{n:Si,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:_s(),fragmentShader:`
	...
	`}function gp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const u=o.mapping,f=u===da||u===pa,p=u===bi||u===Ki;if(f||p){let m=e.get(o);const g=m!==void 0?m.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==g)return t===null&&(t=new ol(i)),m=f?t.fromEquirectangular(o,m):t.fromCubemap(o,m),m.texture.pmremVersion=o.pmremVersion,e.set(o,m),m.texture;if(m!==void 0)return m.texture;{const M=o.image;return f&&M&&M.height>0||p&&M&&r(M)?(t===null&&(t=new ol(i)),m=f?t.fromEquirectangular(o):t.fromCubemap(o),m.texture.pmremVersion=o.pmremVersion,e.set(o,m),o.addEventListener("dispose",s),m.texture):null}}}return o}function r(o){let u=0;const f=6;for(let p=0;p<f;p++)o[p]!==void 0&&u++;return u===f}function s(o){const u=o.target;u.removeEventListener("dispose",s);const f=e.get(u);f!==void 0&&(e.delete(u),f.dispose())}function l(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:l}}function _p(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&yr("WebGLRenderer: "+n+" extension not supported."),r}}}function vp(i,e,t,n){const r={},s=new WeakMap;function l(m){const g=m.target;g.index!==null&&e.remove(g.index);for(const E in g.attributes)e.remove(g.attributes[E]);g.removeEventListener("dispose",l),delete r[g.id];const M=s.get(g);M&&(e.remove(M),s.delete(g)),n.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,t.memory.geometries--}function o(m,g){return r[g.id]===!0||(g.addEventListener("dispose",l),r[g.id]=!0,t.memory.geometries++),g}function u(m){const g=m.attributes;for(const M in g)e.update(g[M],i.ARRAY_BUFFER)}function f(m){const g=[],M=m.index,E=m.attributes.position;let A=0;if(M!==null){const L=M.array;A=M.version;for(let U=0,P=L.length;U<P;U+=3){const I=L[U+0],O=L[U+1],F=L[U+2];g.push(I,O,O,F,F,I)}}else if(E!==void 0){const L=E.array;A=E.version;for(let U=0,P=L.length/3-1;U<P;U+=3){const I=U+0,O=U+1,F=U+2;g.push(I,O,O,F,F,I)}}else return;const v=new(Yl(g)?Ql:Jl)(g,1);v.version=A;const d=s.get(m);d&&e.remove(d),s.set(m,v)}function p(m){const g=s.get(m);if(g){const M=m.index;M!==null&&g.version<M.version&&f(m)}else f(m);return s.get(m)}return{get:o,update:u,getWireframeAttribute:p}}function xp(i,e,t){let n;function r(g){n=g}let s,l;function o(g){s=g.type,l=g.bytesPerElement}function u(g,M){i.drawElements(n,M,s,g*l),t.update(M,n,1)}function f(g,M,E){E!==0&&(i.drawElementsInstanced(n,M,s,g*l,E),t.update(M,n,E))}function p(g,M,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,M,0,s,g,0,E);let v=0;for(let d=0;d<E;d++)v+=M[d];t.update(v,n,1)}function m(g,M,E,A){if(E===0)return;const v=e.get("WEBGL_multi_draw");if(v===null)for(let d=0;d<g.length;d++)f(g[d]/l,M[d],A[d]);else{v.multiDrawElementsInstancedWEBGL(n,M,0,s,g,0,A,0,E);let d=0;for(let L=0;L<E;L++)d+=M[L]*A[L];t.update(d,n,1)}}this.setMode=r,this.setIndex=o,this.render=u,this.renderInstances=f,this.renderMultiDraw=p,this.renderMultiDrawInstances=m}function Mp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,l,o){switch(t.calls++,l){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:ut("WebGLInfo: Unknown draw mode:",l);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Sp(i,e,t){const n=new WeakMap,r=new Rt;function s(l,o,u){const f=l.morphTargetInfluences,p=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,m=p!==void 0?p.length:0;let g=n.get(o);if(g===void 0||g.count!==m){let _=function(){Y.dispose(),n.delete(o),o.removeEventListener("dispose",_)};var M=_;g!==void 0&&g.texture.dispose();const E=o.morphAttributes.position!==void 0,A=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],L=o.morphAttributes.normal||[],U=o.morphAttributes.color||[];let P=0;E===!0&&(P=1),A===!0&&(P=2),v===!0&&(P=3);let I=o.attributes.position.count*P,O=1;I>e.maxTextureSize&&(O=Math.ceil(I/e.maxTextureSize),I=e.maxTextureSize);const F=new Float32Array(I*O*4*m),Y=new jl(F,I,O,m);Y.type=An,Y.needsUpdate=!0;const T=P*4;for(let b=0;b<m;b++){const X=d[b],G=L[b],J=U[b],Q=I*O*4*b;for(let B=0;B<X.count;B++){const H=B*T;E===!0&&(r.fromBufferAttribute(X,B),F[Q+H+0]=r.x,F[Q+H+1]=r.y,F[Q+H+2]=r.z,F[Q+H+3]=0),A===!0&&(r.fromBufferAttribute(G,B),F[Q+H+4]=r.x,F[Q+H+5]=r.y,F[Q+H+6]=r.z,F[Q+H+7]=0),v===!0&&(r.fromBufferAttribute(J,B),F[Q+H+8]=r.x,F[Q+H+9]=r.y,F[Q+H+10]=r.z,F[Q+H+11]=J.itemSize===4?r.w:1)}}g={count:m,texture:Y,size:new Mt(I,O)},n.set(o,g),o.addEventListener("dispose",_)}if(l.isInstancedMesh===!0&&l.morphTexture!==null)u.getUniforms().setValue(i,"morphTexture",l.morphTexture,t);else{let E=0;for(let v=0;v<f.length;v++)E+=f[v];const A=o.morphTargetsRelative?1:1-E;u.getUniforms().setValue(i,"morphTargetBaseInfluence",A),u.getUniforms().setValue(i,"morphTargetInfluences",f)}u.getUniforms().setValue(i,"morphTargetsTexture",g.texture,t),u.getUniforms().setValue(i,"morphTargetsTextureSize",g.size)}return{update:s}}function yp(i,e,t,n){let r=new WeakMap;function s(u){const f=n.render.frame,p=u.geometry,m=e.get(u,p);if(r.get(m)!==f&&(e.update(m),r.set(m,f)),u.isInstancedMesh&&(u.hasEventListener("dispose",o)===!1&&u.addEventListener("dispose",o),r.get(u)!==f&&(t.update(u.instanceMatrix,i.ARRAY_BUFFER),u.instanceColor!==null&&t.update(u.instanceColor,i.ARRAY_BUFFER),r.set(u,f))),u.isSkinnedMesh){const g=u.skeleton;r.get(g)!==f&&(g.update(),r.set(g,f))}return m}function l(){r=new WeakMap}function o(u){const f=u.target;f.removeEventListener("dispose",o),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:s,dispose:l}}const Ep={[Ll]:"LINEAR_TONE_MAPPING",[Ul]:"REINHARD_TONE_MAPPING",[Il]:"CINEON_TONE_MAPPING",[Fl]:"ACES_FILMIC_TONE_MAPPING",[Ol]:"AGX_TONE_MAPPING",[Bl]:"NEUTRAL_TONE_MAPPING",[Nl]:"CUSTOM_TONE_MAPPING"};function Tp(i,e,t,n,r){const s=new Cn(e,t,{type:i,depthBuffer:n,stencilBuffer:r}),l=new Cn(e,t,{type:qn,depthBuffer:!1,stencilBuffer:!1}),o=new yn;o.setAttribute("position",new Wn([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Wn([0,2,0,0,2,0],2));const u=new xf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
#define LOW_PRECISION`),e}const Dm={[rs]:"SHADOWMAP_TYPE_PCF",[gr]:"SHADOWMAP_TYPE_VSM"};function Lm(i){return Dm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Um={[bi]:"ENVMAP_TYPE_CUBE",[Ki]:"ENVMAP_TYPE_CUBE",[ms]:"ENVMAP_TYPE_CUBE_UV"};function Im(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Um[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Fm={[Ki]:"ENVMAP_MODE_REFRACTION"};function Nm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Fm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Om={[Dl]:"ENVMAP_BLENDING_MULTIPLY",[fu]:"ENVMAP_BLENDING_MIX",[hu]:"ENVMAP_BLENDING_ADD"};function Bm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Om[i.combine]||"ENVMAP_BLENDING_NONE"}function zm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Vm(i,e,t,n){const r=i.getContext(),s=t.defines;let l=t.vertexShader,o=t.fragmentShader;const u=Lm(t),f=Im(t),p=Nm(t),m=Bm(t),g=zm(t),M=Em(t),E=Tm(s),A=r.createProgram();let v,d,L=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(v=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,E].filter(_r).join(`
`),v.length>0&&(v+=`
`),d=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,E].filter(_r).join(`
`),d.length>0&&(d+=`
...
`].filter(_r).join(`
`)),l=$a(l),l=Ml(l,t),l=Sl(l,t),o=$a(o),o=Ml(o,t),o=Sl(o,t),l=yl(l),o=yl(o),t.isRawShaderMaterial!==!0&&(L=`#version 300 es
